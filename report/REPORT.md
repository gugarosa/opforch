...
![Distance Metric Speedups](images/01_distance_speedups.png)
...
![Model Accuracy Parity](images/02_model_accuracy_parity.png)
...
![Model Timing](images/03_model_timing.png)
...
![Fit Scaling](images/04_scaling_fit.png)
...
![Predict Scaling](images/05_scaling_predict.png)
...
![Distance Scaling](images/06_distance_scaling.png)
...
![Summary Dashboard](images/07_summary_dashboard.png)
...
![Extended Fit Scaling](images/08_extended_fit_scaling.png)
...
![Extended Predict Scaling](images/09_extended_predict_scaling.png)
...
![Extended Distance Scaling](images/10_extended_distance_scaling.png)
...
![Multi-Model Scaling](images/11_multimodel_scaling.png)
...
![Dimensionality Scaling](images/12_dimension_scaling.png)
...
![GPU Comparison](images/13_gpu_comparison.png)
...
![Extended Dashboard](images/14_extended_dashboard.png)
...
*Report generated automatically. All benchmark data available in `images/benchmark_results.json` and `images/extended_benchmark_results.json`.*
