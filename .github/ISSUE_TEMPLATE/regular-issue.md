...
- [ ] Check that you are up-to-date with the master branch of OPForch. You can update with:
pip install git+git://github.com/gugarosa/opforch.git --upgrade --no-deps

- [ ] Check that you have read all of our [README](https://github.com/gugarosa/opforch/blob/master/README.md).
